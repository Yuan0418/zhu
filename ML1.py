...
len=train_set1.shape[0]#train set cols
print(train_set1.head())

#connect two data sets
merge_data=pd.concat([train_set1,test_set1])

#drop not really useful features
...
#spilt train data set, check over fitting (random_state)
...
mse=mean_squared_error(pred,y)   #evaluate the model
print("mse: ",mse)

"""
print("######train mode/check overfittingl#######")
